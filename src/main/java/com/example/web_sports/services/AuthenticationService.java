...
import com.example.web_sports.entity.InvalidatedToken;
...
import com.example.web_sports.repositories.InvalidatedTokenRepository;
    ...
    private String buildScope(User user) {
        ...
        if (!CollectionUtils.isEmpty(user.getRoles())) {
            user.getRoles().forEach(role -> {
                stringJoiner.add("ROLE_" + role.getName()); // Chỉ thêm tên role
            });
        }
